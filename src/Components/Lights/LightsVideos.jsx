  ...
  return (
    <div className="w-full h-[90vh] md:h-[95vh] py-7">
      <div
        ...
        className="bg-gradient-to-r from-[#1E120A] to-[#343434] rounded w-5/6 md:w-4/5 h-96 mx-auto relative"
      >
        <div className="flex w-4/5 mx-auto justify-between items-center gap-3 pt-5">
          <h3 className="text-xl md:text-2xl font-bold text-white">
            Premium quality and watch our <br /> hottest carport videos
          </h3>
                ...
                <label htmlFor="my-modal-5" className="w-full modal-button">
                  <h1 className="w-full flex justify-center">
                    <img
                      width="120"
                      height="120"
                      src="https://i.ibb.co/nR9sdnD/Group-39.png"
