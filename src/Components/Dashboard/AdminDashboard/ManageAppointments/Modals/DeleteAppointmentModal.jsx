        ...
        <div>
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box relative">
                    <div className="absolute top-0 left-0 mix-blend-darken opacity-5">
                    ...
                    <h1 className='mb-4 badge badge-xs text-white badge-error text-sm p-4'>{`Delete ${name}'s Appointment`}</h1>
