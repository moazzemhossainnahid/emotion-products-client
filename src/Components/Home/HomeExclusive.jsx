        ...
        <div className='w-full'>
            <div class='w-full flex flex-col bg-white md:flex-row items-center justify-between py-10 gap-5'>
                <div class="h-96 w-full rounded-xl relative group" >
                    <div class="z-50 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-primary/50 to-transparent bg-gradient-to-t inset-x-0 bottom-0 text-white flex items-end">
                        <div className='w-4/5 mx-auto'>
                            <div class="p-4 space-y-3 text-xl text-center group-hover:opacity-100 group-hover:translate-y-0 translate-y-4  transform transition duration-300 ease-in-out">
                                ...
                                <button className='btn btn-primary mx-auto flex items-center gap-2 rounded hover:btn-warning'>Discover More <FaArrowRight /></button>
                            </div>
                        </div>
                    </div>
